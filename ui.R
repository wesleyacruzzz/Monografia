      ...
      tabItem(tabName = "esc",
              ...
              helpText("●", HTML("<b>Visualização de variáveis aleatórias:</b>"), "Nessa seção o usuário 
                      poderá visualizar o histograma, gráfico de
                       ...
                       e gráfico da distribuição acumulada das variáveis aleatórias
              ...
              helpText("●", HTML("<b>Transformação de variáveis aleatórias:</b>"), "Nessa seção o usuário
                       ...
                       quando são aplicadas transformações na variável original, será
                       apresentado um breve resumo das possíveis transformações para cada
                       variável e um gráfico do histograma e a densidade da variável
                       aleatória escolhida. Tudo nos conformes da disciplina de
                       probabilidade básica I ministrada na UFRN."),
